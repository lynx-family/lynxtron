...
#ifndef LYNXTRON_SHELL_API_LYNX_VIEW_MODULE_LYNX_NODE_MODULE_H_
#define LYNXTRON_SHELL_API_LYNX_VIEW_MODULE_LYNX_NODE_MODULE_H_
...
#endif  // LYNXTRON_SHELL_API_LYNX_VIEW_MODULE_LYNX_NODE_MODULE_H_
