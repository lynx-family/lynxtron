...
#ifndef LYNXTRON_SHELL_API_NOTIFICATIONS_NOTIFICATION_DELEGATE_H_
#define LYNXTRON_SHELL_API_NOTIFICATIONS_NOTIFICATION_DELEGATE_H_
...
#endif  // LYNXTRON_SHELL_API_NOTIFICATIONS_NOTIFICATION_DELEGATE_H_
