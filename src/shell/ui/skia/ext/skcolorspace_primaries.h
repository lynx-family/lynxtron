...
#ifndef LYNXTRON_SHELL_UI_SKIA_EXT_SKCOLORSPACE_PRIMARIES_H_
#define LYNXTRON_SHELL_UI_SKIA_EXT_SKCOLORSPACE_PRIMARIES_H_
...
#endif  // LYNXTRON_SHELL_UI_SKIA_EXT_SKCOLORSPACE_PRIMARIES_H_
