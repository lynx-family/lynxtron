...
#ifndef LYNXTRON_SHELL_COMMON_GIN_HELPER_PERSISTENT_DICTIONARY_H_
#define LYNXTRON_SHELL_COMMON_GIN_HELPER_PERSISTENT_DICTIONARY_H_
...
#endif  // LYNXTRON_SHELL_COMMON_GIN_HELPER_PERSISTENT_DICTIONARY_H_
