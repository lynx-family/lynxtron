...
async function main() {
  ...
  let templateDir = path.resolve(__dirname, 'dist', 'browser-demo');
  if (!fs.existsSync(templateDir)) {
    const siblingDist = path.resolve(__dirname, '..', 'dist', 'browser-demo');
    if (fs.existsSync(siblingDist)) {
      templateDir = siblingDist;
    } else {
      const rootTemplate = path.resolve(__dirname, 'browser-demo');
      const siblingRootTemplate = path.resolve(__dirname, '..', 'browser-demo');
  ...
  console.log('Created Lynxtron browser demo app at', targetDir);
