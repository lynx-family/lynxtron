// Type definitions for Lynxtron 36.4.0-rs.6.develop.tmp.15
// Project: http://electronjs.org/
// Definitions by: The Lynxtron Team <https://github.com/electron/electron>
...
declare namespace Lynxtron {
  ...
  interface App extends NodeJS.EventEmitter {
     ...
     * running the first tick of the event loop. If an Lynxtron API needs to be called
    ...
    /**
     * Emitted when Lynxtron has created a new `session`.
     */
    ...
    getApplicationInfoForProtocol(
      url: string
    ): Promise<Lynxtron.ApplicationInfoForProtocolReturnValue>;
    /**
    ...
    /**
     * The baseboard's serial number.
     *
     * @platform win32
     */
    getBaseboardUUID(): string;
    /**
    ...
    /**
     * The product name of PC device.
     *
     * @platform win32
     */
    getDeviceModalName(): string;
    /**
     * The device model of device.
     *
     * @platform darwin,win32
     */
    ...
    /**
     * The first harddrive's serial number.
     *
     * @platform win32
     */
    getDiskSerialNumber(): string;
    /**
     * The last harddrive's serial number.
     *
     * @platform win32
     */
    getDiskSerialNumberLegacy(): string;
    /**
    ...
    /**
     * The timestamp of launcher process creation.
     *
     * @platform win32
     */
    getLauncherProcessCreationTime(): number;
    /**
    ...
    /**
     * The first adapter's MAC address.
     *
     * @platform win32
     */
    ...
    /**
     * the interval from CreationTime to animation show, unit: ms.
     *
     * @platform darwin,win32
     */
    getStartupWindowShowTime(): string;
    /**
    ...
    /**
     * testPayload, only use for test.
     *
     * @platform linux,darwin,win32
     */
    getTtFusesTestPayload(): string;
    /**
    ...
    getVersion(): string;
    /**
     * The timestamp of WinMain entrance.
     *
     * @platform win32
     */
    getWinMainStartTime(): number;
    /**
    ...
    /**
     * Whether the app is launched from a ssd disk.
     *
     * @platform win32
     */
    isDiskSSD(): boolean;
    ...
    /**
     * Whether the app is first launched since system booting.
     *
     * @platform win32
     */
    isExeFirstStart(): boolean;
    /**
    ...
    /**
     * `true` if startup animation is showing.
     *
     * @platform darwin,win32
     */
    isStartupWindowShowing(): boolean;
    /**
    ...
    /**
     * Resolves when the elevation service is complete.
     *
     * @platform win32
     */
    runAsElevated(launchInfo: LaunchInfo): Promise<boolean>;
    /**
    ...
    /**
     * A `string` which is the user agent string Lynxtron will use as a global
     * fallback.
     *
  ...
  interface AtomAutoUpdater extends NodeJS.EventEmitter {
    // Docs: https://electronjs.org/docs/api/atom-auto-updater

    /**
     * Triggered after calling quitAndInstall function.
     */
    on(event: 'before-quit-for-install', listener: () => void): this;
    off(event: 'before-quit-for-install', listener: () => void): this;
    once(event: 'before-quit-for-install', listener: () => void): this;
    addListener(event: 'before-quit-for-install', listener: () => void): this;
    removeListener(
      event: 'before-quit-for-install',
      listener: () => void
    ): this;
    /**
     * Triggered after checking for updates, Upgrade information can be obtained through this event.
     */
    on(
      event: 'check-update-finished',
      listener: (event: Event, checkUpdateResult: CheckUpdateResult) => void
    ): this;
    off(
      event: 'check-update-finished',
      listener: (event: Event, checkUpdateResult: CheckUpdateResult) => void
    ...
    /**
     * Triggered after downloading an update, DownloadResult can be obtained through this event.
     */
    on(
      event: 'download-finished',
      listener: (event: Event, downloadResult: DownloadResult) => void
    ): this;
    off(
      event: 'download-finished',
      listener: (event: Event, downloadResult: DownloadResult) => void
    ...
    /**
     * Triggered when the download progress of an update changes. DownloadProgress can be obtained through this event.
     */
    on(
    ...
    /**
     * Triggered when an error occurs while performing a task. Error code and error message can be obtained through this event.
     */
    on(
      event: 'error',
      listener: (
    ...
    /**
     * Triggered after a silent installation is completed, InstallResult can be obtained through this event.
     */
    on(
      event: 'silent-install-finished',
      listener: (event: Event, installResult: InstallResult) => void
    ): this;
    off(
      event: 'silent-install-finished',
      listener: (event: Event, installResult: InstallResult) => void
    ...
    checkForUpdates(config: Config): void;

    cleanUpCache(aid: string): void;

    download(downloadConfig: DownloadConfig): void;

    init(): void;

    initReporterInfo(reporterInfo: ReporterInfo): void;

    isDownloading(): void;

    quitAndInstall(installConfig: InstallConfig): void;

    silentInstall(installConfig: InstallConfig): void;
  }
  ...
  interface AutoUpdaterV2 extends NodeJS.EventEmitter {
    // Docs: https://electronjs.org/docs/api/auto-updater-v2
    ...
    on(
      event: 'error',
      listener: (event: Event, code: number, errorMsg: string) => void
    ): this;
    off(
      event: 'error',
      listener: (event: Event, code: number, errorMsg: string) => void
    ...
    /**
     * Emitted when installer finish silent install.
     *
     * @platform win32
     */
    on(event: 'silent-install-finished', listener: () => void): this;
    /**
     * @platform win32
     */
    off(event: 'silent-install-finished', listener: () => void): this;
    /**
     * @platform win32
     */
    once(event: 'silent-install-finished', listener: () => void): this;
    /**
     * @platform win32
     */
    addListener(event: 'silent-install-finished', listener: () => void): this;
    /**
     * @platform win32
     */
    removeListener(
    ...
    on(
      ...
      listener: (event: Event, updateInfo: UpdateInfo) => void
    ): this;
    off(
      event: 'update-available',
      listener: (event: Event, updateInfo: UpdateInfo) => void
    ...
    removeListener(event: 'update-not-available', listener: () => void): this;
    /**
     * you can call in downloading
     */
    cancelDownload(): void;
    /**
     * Asks the server whether there is an update. You must call `init` before using
     * this API.
     *
     * **Note:** If an update is available it will be downloaded by `strategy`. Calling
     * `autoUpdater.checkForUpdates()` twice will download the update two times.
     */
    checkForUpdates(): void;
    /**
     * when strategy is `manual`, file will not be downloaded automatically when
     * strategy is `slience_download` or `slience_install`, file will be downloaded
     * automatically
     */
    download(): void;
    /**
     * after  `update-downloaded` you can call this to install
     */
    install(): void;
    /**
     * you can use it to check if it's downloading
     */
    isDownloading(): void;
    setUpdateInfo(options: UpdateInfoOptions): void;
    /**
     * after  `update-downloaded` you can call this to run silence install with
     * AppShell Installer
     */
    silenceInstall(): void;
  }
  ...
  interface BaseWindowConstructorOptions {
    ...
    thickFrame?: boolean;
    /**
     * Default window title. Default is `"Lynxtron"`. If the HTML tag `<title>` is
  ...
  class ClientRequest extends NodeEventEmitter {
     ...
     * internally buffered inside Lynxtron process memory.
     */
  ...
  interface ContentTracing {
     ...
     *
     * > **NOTE:** Lynxtron adds a non-default tracing category called `"electron"`.
     * This category can be used to capture Lynxtron-specific tracing events.
     */
     ...
     * full state.
     */
    getTraceBufferUsage(): Promise<Lynxtron.TraceBufferUsageReturnValue>;
    /**
  ...
  class Cookies extends NodeEventEmitter {
     ...
     * with the response.
     */
    get(filter: CookiesGetFilter): Promise<Lynxtron.Cookie[]>;
    /**
  ...
  interface DesktopCapturer {
    ...
    ): Promise<Lynxtron.DesktopCapturerSource[]>;
  }
  ...
  interface Dialog {
    ...
    ): Promise<Lynxtron.MessageBoxReturnValue>;
    /**
     * resolves with a promise containing the following properties:
     *
     * * `response` number - The index of the clicked button.
    ...
    ): Promise<Lynxtron.OpenDialogReturnValue>;
    /**
     * Resolve with an object containing the following:
     *
     * * `canceled` boolean - whether or not the dialog was canceled.
    ...
    ): Promise<Lynxtron.SaveDialogReturnValue>;
    /**
     * Resolve with an object containing the following:
     *
     * * `canceled` boolean - whether or not the dialog was canceled.
  ...
  class DownloadItem extends NodeEventEmitter {
     ...
     * `path` doesn't exist, Lynxtron will try to make the directory recursively. If
     * user doesn't set the save path via the API, Lynxtron will use the original
     ...
     * If user doesn't set the save path via the property, Lynxtron will use the
  ...
  class Extensions extends NodeEventEmitter {
     ...
     * an API that Lynxtron does not support) then they will be logged to the console.
     *
     * Note that Lynxtron does not support the full range of Chrome extensions APIs.
     * See Supported Extensions APIs for more details on what is supported.
     *
     * Note that in previous versions of Lynxtron, extensions that were loaded would be
  ...
  interface HotRect {
    // Docs: https://electronjs.org/docs/api/structures/hot-rect

    /**
     * Rects for the window
     */
    rects: Rectangle[];
    /**
     * user defined hot rect type
     */
    type: string;
  }
  ...
  interface InAppPurchase extends NodeJS.EventEmitter {
     ...
     */
    getProducts(productIDs: string[]): Promise<Lynxtron.Product[]>;
    /**
  ...
  class IpcClient extends NodeEventEmitter {
    // Docs: https://electronjs.org/docs/api/ipc-client

    /**
     * Resolves with a IpcClient A promise that resolves with an IpcClient object that
     * can later be used to post messages to the service host when the connection is
     * established, or rejects if the connection fails to be established. Connect to a
     * service host, and if the service is not currently running, it will try to launch
     * a new service process using the provided parameters.
     */
    static connectService(
      serviceName: string,
      exePath: string,
      args?: string[]
    ): Promise<Lynxtron.IpcClient>;
    /**
     * A promise that resolves with an IpcClient object that can later be used to post
     * messages to the service host, or rejects if the connection fails to be
     * established. Same as connectService, but it will not try to launch a new service
     * process if it is not currently running.
     */
    static queryService(serviceName: string): Promise<Lynxtron.IpcClient>;
    /**
     * This method must be called to set a group name, which should be the same unique
     * string among all processes of the application.
     */
    static setGroupName(name: string): void;
    /**
     * Emitted once the service has stopped.
     */
    ...
    /**
     * Send a message to the service process, optionally transferring ownership of zero
     * or more `MessagePortMain` objects. The client and service host can then
     * communicate with each other using the ports.
     */
    postMessage(
      channel: string,
      message: any,
    ...
    /**
     * A `boolean` property that indicates if the service is running.
     */
    running: boolean;
  }
  ...
  interface IpcRenderer extends NodeJS.EventEmitter {
     ...
     * Lynxtron objects will throw an exception.
     *
     * Since the main process does not have support for DOM objects such as
     * `ImageBitmap`, `File`, `DOMMatrix` and so on, such objects cannot be sent over
     * Lynxtron's IPC to the main process, as the main process would have no way to
     ...
     * dangerous Lynxtron APIs to the renderer process. See the security guide for more
     * info. :::
     */
    on(
      channel: string,
  ...
  class IpcService {
    // Docs: https://electronjs.org/docs/api/ipc-service

    static create(serviceName: string): IpcService;
    on(channel: string, listener: (messageEvent: MessageEvent) => void): this;
    /**
     * Start the service.
     */
    run(): void;
    /**
     * A `string` property for the name of the service.
     */
    name: string;
  }
  ...
  interface Lynx extends NodeJS.EventEmitter {
    // Docs: https://electronjs.org/docs/api/lynx

    /**
     * Emitted when receive an event published by LynxWindow
     */
    on(
      event: '-lynx-publish-event',
      listener: (
        event: Event,
        /**
        ...
        event_name: string,
        /**
         * The parameter object passed from LynxWindow
         */
        param: any,
        /**
         * timestamp
    ...
    /**
     * if called succeeded,return true;otherwise return false.
     */
    enableLog(options: EnableLogOptions): Promise<boolean>;
    /**
     * Returns a list of `String` - include current lynx log file and backup file(if
     * exists).
     */
    getLogList(): void;
    /**
     * current lynx log file path.
     */
    getLogPath(): string;
    publishEvent(eventName: string, param: any, time: number): void;
  }

  class BaseWindow extends NodeEventEmitter {
    // Docs: https://electronjs.org/docs/api/lynx-base-window
     ...
     * In Lynxtron, returning any value other than `undefined` would cancel the close.
     * For example:
     *
     ...
     * window shape.
     *
     * `BaseWindow`s that are transparent can sometimes leave behind visual
     ...
     * removed in future Lynxtron releases.
     *
     * @platform darwin
     */
     ...
     * among all `BaseWindow` instances of the entire Lynxtron application.
     *
     */
    readonly id: number;
    /**
  ...
  interface LynxBridgeMain extends NodeJS.EventEmitter {
    /**
     * Add a handler for `channel` witch was invokeable.
     */
    handle(
      channel: string,
      listener: (event: LynxMainEvent, args: any[]) => void
    ): void;
    /**
     * Handle an invokeable `channel` and then remove the handler.
     */
    handleOnce(
      channel: string,
      listener: (event: LynxMainEvent, args: any[]) => void
    ...
    removeAllListeners(channel?: string): this;
    /**
     * Remove all handlers in specific `channel` if exist.
     */
    removeHandler(channel: string): void;
    /**
     * Removes the specified `listener` from the listener array for the specified
  ...
  interface LynxMainEvent extends Event {
    // Docs: https://electronjs.org/docs/api/structures/lynx-main-event
    ...
    returnValue: any;
    /**
     * Returns the `lynxWindow` that sent the message
     */
    sender: LynxWindow;
    /**
  ...
  class LynxWindow extends BaseWindow {
    // Docs: https://electronjs.org/docs/api/lynx-window
    ...
    removeListener(event: 'move', listener: () => void): this;
    /**
     * Emitted once when the window is moved to a new position. On macOS this event is
     * an alias of `move`.
     *
     * @platform darwin,win32
     */
     ...
     * @platform darwin
     */
    on(event: 'scroll-touch-begin', listener: () => void): this;
    /**
     * @platform darwin
     */
    off(event: 'scroll-touch-begin', listener: () => void): this;
    /**
     * @platform darwin
     */
    once(event: 'scroll-touch-begin', listener: () => void): this;
    /**
     * @platform darwin
     */
    addListener(event: 'scroll-touch-begin', listener: () => void): this;
    /**
     * @platform darwin
     */
    removeListener(event: 'scroll-touch-begin', listener: () => void): this;
    /**
     * Emitted when scroll wheel event phase filed upon reaching the edge of element.
     *
     * @platform darwin
     */
    on(event: 'scroll-touch-edge', listener: () => void): this;
    /**
     * @platform darwin
     */
    off(event: 'scroll-touch-edge', listener: () => void): this;
    /**
     * @platform darwin
     */
    once(event: 'scroll-touch-edge', listener: () => void): this;
    /**
     * @platform darwin
     */
    addListener(event: 'scroll-touch-edge', listener: () => void): this;
    /**
     * @platform darwin
     */
    removeListener(event: 'scroll-touch-edge', listener: () => void): this;
    /**
     * Emitted when scroll wheel event phase has ended.
     *
     * @platform darwin
     */
    on(event: 'scroll-touch-end', listener: () => void): this;
    /**
     * @platform darwin
     */
    off(event: 'scroll-touch-end', listener: () => void): this;
    /**
     * @platform darwin
     */
    once(event: 'scroll-touch-end', listener: () => void): this;
    /**
     * @platform darwin
     */
    addListener(event: 'scroll-touch-end', listener: () => void): this;
    /**
     * @platform darwin
     */
    removeListener(event: 'scroll-touch-end', listener: () => void): this;
    /**
     * Emitted when window session is going to end due to force shutdown or machine
     * restart or session log off.
     *
     ...
     * @platform darwin
     */
    // addTabbedWindow(lynxWindow: LynxWindow): void;
    /**
     * Removes focus from the window.
     */
    blur(): void;
     ...
     * current window into a top-level window.
     */
    setParentWindow(parent: LynxWindow | null): void;
    /**
     * Moves window to `x` and `y`.
     */
    setPosition(x: number, y: number, animate?: boolean): void;
    ...
    /**
     * A `Integer` property representing the unique ID of the window. Each ID is unique
     * among all `LynxWindow` instances of the entire Lynxtron application.
     *
     */
    readonly id: number;
    /**
  ...
  class MessageChannelLite {
    // Docs: https://electronjs.org/docs/api/message-channel-lite
  ...
  interface NativeConfigManager {
    // Docs: https://electronjs.org/docs/api/native-config-manager

    apply(customConfig: any): void;
    /**
     * All electron config(excluding client config) including settings and `apply`
     */
    getAllLynxtronConfig(): string;
    /**
     * The client's remote config or from local disk cache.
     */
    getClientConfigFromCacheFile(): string;
    init(nativeConfigManagerPerfs: NativeConfigManagerPerfs): void;
    setListener(
      nativeConfigManagerCallback: ((config: string) => void) | null
    ): void;
  }
  ...
  interface NativeTheme extends NodeJS.EventEmitter {
     ...
     * * Any UI Lynxtron renders on Linux and Windows including context menus,
  ...
  interface Parfait {
    // Docs: https://electronjs.org/docs/api/parfait
     ...
     * record successfully.
     */
    launchReport(): Promise<boolean>;
    /**
     * logRecord successfully.
     */
    logRecord(level: number, category: string, log: string): Promise<boolean>;
    /**
     * record successfully.
     */
    record(
    ...
    /**
     * immediately upload logs successfully.
     */
    upload(): Promise<boolean>;
    /**
     * immediately upload alog successfully.
     */
    uploadAlog(startTime: number, endTime: number): Promise<boolean>;
    /**
     * if uploadFile succeeded,return true;otherwise return false.
     */
    uploadFile(filePath: string): Promise<boolean>;
    /**
     * write parfait alog successfully.
     */
    writeAlog(tag: string, msg: string): Promise<boolean>;
    /**
     * write parfait alog successfully.
     */
    writeAlog(level: number, tag: string, msg: string): Promise<boolean>;
  }
  ...
  interface PcInfo {
    // Docs: https://electronjs.org/docs/api/pc-info
     ...
     * @platform win32
     */
    getMonitor(): Promise<string>;
  }

  interface PerfMonitor extends NodeJS.EventEmitter {
    // Docs: https://electronjs.org/docs/api/perf-monitor

    addProc(perfMonitorPid: number): Promise<boolean>;

    addReportHeader(
      perfMonitorKey: string,
      perfMonitorValue: string
    ): Promise<boolean>;

    mark(key: string): void;

    on(
      perfMonitorChannel: string,
      perfMonitorListener: (event: string, ...args: any[]) => void
    ): this;
    ...
    removeAllListeners(perfMonitorChannel: string): this;
    ...
    removeProc(perfMonitorPid: number): Promise<boolean>;

    setCpuMonitor(cpuMonitorParam: CpuMonitorParam): Promise<boolean>;

    setFpsMonitor(fpsMonitorParam: FpsMonitorParam): Promise<boolean>;

    setGpuMonitor(gpuMonitorParam: GpuMonitorParam): Promise<boolean>;

    setHangMonitor(hangMonitorParam: HangMonitorParam): Promise<boolean>;

    setHardwareMonitor(
      hardwareMonitorParam: HardwareMonitorParam
    ): Promise<boolean>;

    setMemoryMonitor(memoryMonitorParam: MemoryMonitorParam): Promise<boolean>;

    setProcAlias(
      perfMonitorPid: number,
      perfMonitorAlias: string
    ): Promise<boolean>;

    setSampleInterval(perfMonitorIntervalSeconds: number): Promise<boolean>;

    setUsedAb(key: string, value: number): void;

    trackLastPoint(point: string): void;

    trackStartup(step: string, value?: string): void;
  }
  ...
  interface PowerMonitor extends NodeJS.EventEmitter {
     ...
     * invokes `e.preventDefault()`, Lynxtron will attempt to delay system shutdown in
  ...
  interface ProcessMemoryInfo {
     ...
     * Lynxtron code itself in Kilobytes.
     */
    shared: number;
  }
  ...
  interface Protocol {
    ...
    /**
     * Whether the protocol was successfully custom intercepted
     *
     * Intercepts `scheme` protocol and uses `handler` as the protocol's new handler
     * which sends a `Buffer` as a response.
     */
    customInterceptBufferProtocol(
      scheme: string,
      handler: (
        request: ProtocolRequest,
        callback: (
          CustomInterceptParams: CustomInterceptParams,
    ...
    /**
     * Whether `scheme` is already custom intercepted.
     */
    customIsProtocolIntercepted(scheme: string): boolean;
    /**
     * Whether the protocol was successfully custom unintercepted
     *
     * Remove the interceptor installed for `scheme` and restore its original handler.
     */
    customUninterceptProtocol(scheme: string): boolean;
    /**
  ...
  interface SccSafeBrowsingConfig {
    // Docs: https://electronjs.org/docs/api/scc-safe-browsing

    /**
     * If you need this feature, Please Call the methods to config scc feature.
     */
    setSafeBrowsingStatus(options: SafeBrowsingStatusOptions): void;
  }
  ...
  class ServiceWorkers extends NodeEventEmitter {
     ...
     * @experimental
     */
    startWorkerForScope(scope: string): Promise<Lynxtron.ServiceWorkerMain>;
  }
  ...
  class Session extends NodeEventEmitter {
    ...
    /**
     * Emitted when Lynxtron is about to download `item` in `webContents`.
     *
    ...
    ): Promise<Lynxtron.SharedDictionaryInfo[]>;
    /**
     * an array of shared dictionary information entries in Chromium's networking
     * service's storage.
     *
     ...
     * shared dictionary APIs in Lynxtron to make use of this advanced web feature, but
    ...
    getSharedDictionaryUsageInfo(): Promise<
      Lynxtron.SharedDictionaryUsageInfo[]
    >;
    /**
     ...
     * this setting is an empty list Lynxtron will try to populate this setting with
     ...
     * of Lynxtron is to store granted device permission in memory. If longer term
    ...
    setProxy(config: ProxyConfig): Promise<void>;
    /**
     * By default Lynxtron will download hunspell dictionaries from the Chromium CDN.
  ...
  class SimpleKVStore {
    // Docs: https://electronjs.org/docs/api/simple-kv-store
  ...
  interface SystemPreferences extends NodeJS.EventEmitter {
     ...
     * of the permission request. See Lynxtron Application Distribution for more
     * information about how to set these in the context of Lynxtron.
     *
  ...
  interface TTMetrics {
    // Docs: https://electronjs.org/docs/api/tt-metrics

    /**
     * The `networkListener` will be called with `networkListener(details)` when a
     * network info is received.
     */
    setNetworkListener(
      filter: WebRequestFilter,
      networkListener:
        | ((details: NetworkListenerNetworkListenerDetails) => void)
        | null
    ): void;
    /**
     * The `networkListener` will be called with `networkListener(details)` when a
  ...
  class WebContents extends NodeEventEmitter {
     ...
     */
    capturePage(rect?: Rectangle, opts?: Opts): Promise<Lynxtron.NativeImage>;
    /**
     ...
     */
    enableDeviceEmulation(parameters: EnableDeviceEmulationParameters): void;
    /**
     ...
     */
    getPrintersAsync(): Promise<Lynxtron.PrinterInfo[]>;
    /**
    ...
    isPainting(): boolean;
    /**
     * Whether WebContents is visible.
     */
     ...
     * systems.
     *
     * Prints window's web page. When `silent` is set to `true`, Lynxtron will pick the
     ...
     * :::warning
     *
     * Sending non-standard JavaScript types such as DOM objects or special Lynxtron
     * objects will throw an exception.
     *
     * :::
     *
     * For additional reading, refer to Lynxtron's IPC guide.
     */
    send(channel: string, ...args: any[]): void;
    /**
     ...
     *
     * By default Lynxtron manages the devtools by creating an internal `WebContents`
     ...
     *
     * > [!NOTE] Visual zoom is disabled by default in Lynxtron. To re-enable it, call:
     */
     ...
     * among all `WebContents` instances of the entire Lynxtron application.
     *
     */
    readonly id: number;
    /**
  ...
  interface WebFrame {
     ...
     * previous navigation).
     *
     * Note that blindly calling this method probably makes Lynxtron slower since it
  ...
  class WebFrameMain extends NodeEventEmitter {
     ...
     *
     * See also how the Page Visibility API is affected by other Lynxtron APIs.
     *
     */
  ...
  interface WebPreferences {
    ...
    backgroundThrottling?: boolean;
    /**
     * Whether to run Lynxtron APIs and the specified `preload` script in a separate
     ...
     * `JSON`, etc.), which are all invisible to the loaded content. The Lynxtron API
     ...
     * Lynxtron APIs being used.  This option uses the same technique used by Chrome
     * Content Scripts.  You can access this context in the dev tools by selecting the
     * 'Lynxtron Isolated Context' entry in the combo box at the top of the Console
     * tab.
     */
  ...
  interface WebviewTag extends HTMLElement {
     ...
     * whole visible page.
     */
    capturePage(rect?: Rectangle): Promise<Lynxtron.NativeImage>;
    /**
    ...
    useragent: string;
    /**
     * A `string` which is `v1` or `v2`, `v1` is default behavior of Lynxtron. `v2`
     * will set `document.visibilityState` to follow  The true state of visibility of
     * frame
     */
  ...
  class WinRegAccessEnum {
    // Docs: https://electronjs.org/docs/api/win-reg-key

    /**
     * A `Number` object,对应 windows 注册表标志位 KEY_ALL_ACCESS.
     *
     */
    readonly ALL_ACCESS: number;
    /**
     * A `Number` object,对应 windows 注册表标志位 KEY_CREATE_LINK.
     *
     */
    readonly CREATE_LINK: number;
    /**
     * A `Number` object,对应 windows 注册表标志位 KEY_CREATE_SUB_KEY.
     *
     */
    readonly CREATE_SUB_KEY: number;
    /**
     * A `Number` object,对应 windows 注册表标志位 KEY_ENUMERATE_SUB_KEYS.
     *
     */
    readonly ENUMERATE_SUB_KEYS: number;
    /**
     * A `Number` object,对应 windows 注册表标志位 KEY_EXECUTE.
     *
     */
    readonly EXECUTE: number;
    /**
     * A `Number` object,对应 windows 注册表标志位 KEY_NOTIFY.
     *
     */
    readonly NOTIFY: number;
    /**
     * A `Number` object,对应 windows 注册表标志位 KEY_QUERY_VALUE.
     *
     */
    readonly QUERY_VALUE: number;
    /**
     * A `Number` object,对应 windows 注册表标志位 KEY_READ.
     *
     */
    readonly READ: number;
    /**
     * A `Number` object,对应 windows 注册表标志位 KEY_SET_VALUE.
     *
     */
    readonly SET_VALUE: number;
    /**
     * A `Number` object,对应 windows 注册表标志位 KEY_WOW64_32KEY.
     *
     */
    readonly WOW64_32KEY: number;
    /**
     * A `Number` object,对应 windows 注册表标志位 KEY_WOW64_64KEY.
     *
     */
    readonly WOW64_64KEY: number;
    /**
     * A `Number` object,对应 windows 注册表标志位 KEY_WRITE.
     *
     */
  ...
  class WinRegKey {
    ...
    constructor();
    /**
     * * `result` boolean - `true` 操作执行成功.
     * * `msg` string - 错误信息字符串.
     * * `code` number - Windows 系统错误码用于分析错误原因.
     *
     * 删除当前注册表项中指定名称的子项的值,当传入空字符串时会删除当前项,谨慎使用该接口.
     */
    deleteKey(keyName: string): DeleteKey;
    /**
     * * `result` boolean - `true` 操作执行成功.
     * * `msg` string - 错误信息字符串.
     * * `code` number - Windows 系统错误码用于分析错误原因.
     *
     * 删除当前注册表项中指定名称的值,谨慎使用该接口.
     */
    deleteValue(valueName: string): DeleteValue;
    /**
     * 当前注册表项中值的数量.
     *
     * 用于获取当前注册表项中值的数量.
    ...
    /**
     * * `valueName` string - 当前注册表项中指定索引处值的名称.
     * * `result` boolean - `true` 操作执行成功.
     * * `msg` string - 错误信息字符串.
     * * `code` number - Windows 系统错误码用于分析错误原因.
     *
     * 用于获取当前注册表项中指定位置值的名称.
     */
    getValueNameAt(index: number): ValueNameAt;
    /**
     * result
     *
     * 判断当前注册表项中是否存在某个值
     ...
     * 当前 WinRegKey 对象是否有效.
     *
     * 用于判断当前 WinRegKey 对象是否有效(即是否真正持有某个注册表项的句柄).
     */
    isValid(): boolean;
    /**
     * * `result` boolean - `true` 操作执行成功.
    ...
    /**
     * * `valueType` number - 注册表类型 ValueType 枚举值之一.
     * * `result` boolean - `true` 操作执行成功.
     * * `msg` string - 错误信息字符串.
     * * `code` number - Windows 系统错误码用于分析错误原因.
     *
     * 获取当前注册表项中某个值的类型信息
     */
    queryValueType(valueName: string): QueryValueType;
    /**
     * * `value` number | string | string[] | ArrayBuffer | null - 获取的注册表项中某个值的内容.
     * * `result` boolean - `true` 操作执行成功.
     * * `msg` string - 错误信息字符串.
     * * `code` number - Windows 系统错误码用于分析错误原因.
     *
     * 获取当前注册表项中某个值的内容,返回值根据查询类型而定,当类型为 DWORD 和 QWORD 时返回值类型为 Number,当类型为 REG_SZ 和
     * REG_EXPAND_SZ 时返回值类型为 String,当类型为 REG_MULTI_SZ 时返回值类型为 String Array,当类型为
     * REG_BINARY 时返回值类型为 ArrayBuffer,当某些情况获取失败时返回值为 null.
     */
    readValue(valueName: string, valueType: number): ReadValue;
    /**
     * * `result` boolean - `true` 操作执行成功.
     * * `msg` string - 错误信息字符串.
     * * `code` number - Windows 系统错误码用于分析错误原因.
     *
     * 用于向当前注册表项中存入数据,值的内容类型根据传入的值类型而定,当值类型为 DWORD 和 QWORD 时应该传入 Number 类型,当值类型为 REG_SZ
     * 和 REG_EXPAND_SZ 时应该传入 String 类型,当值类型为 REG_MULTI_SZ 时应该传入 String Array 类型,当值类型为
     * REG_BINARY 时应该传入 ArrayBuffer 类型.
     */
    writeValue(
      valueName: string,
      valueType: number,
      value: number | string | string[] | ArrayBuffer
    ): WriteValue;
    /**
     * A `WinRegAccessEnum` Object.
     */
    static Access: WinRegAccessEnum;
    /**
     * A `WinRegRootKeyEnum` Object.
     */
    static RootKey: WinRegRootKeyEnum;
    /**
     * A `WinRegValueTypeEnum` Object.
     */
    static ValueType: WinRegValueTypeEnum;
  }

  class WinRegRootKeyEnum {
    // Docs: https://electronjs.org/docs/api/win-reg-key

    /**
     * A `Number` object,对应 windows 注册表 HKEY_CURRENT_CONFIG.
     *
     */
    readonly HKCC: number;
    /**
     * A `Number` object,对应 windows 注册表 HKEY_CLASSES_ROOT.
     *
     */
    readonly HKCR: number;
    /**
     * A `Number` object,对应 windows 注册表 HKEY_CURRENT_USER.
     *
     */
    readonly HKCU: number;
    /**
     * A `Number` object,对应 windows 注册表 HKEY_LOCAL_MACHINE.
     *
     */
    readonly HKLM: number;
    /**
     * A `Number` object,对应 windows 注册表 HKEY_USERS.
     *
     */
    readonly HKU: number;
  }

  class WinRegValueTypeEnum {
    // Docs: https://electronjs.org/docs/api/win-reg-key

    /**
     * A `Number` object,对应 windows 注册表标数据类型 REG_BINARY.
     *
     */
    readonly BINARY: number;
    /**
     * A `Number` object,对应 windows 注册表标数据类型 REG_DWORD.
     *
     */
    readonly DWORD: number;
    /**
     * A `Number` object,对应 windows 注册表标数据类型 REG_EXPAND_SZ.
     *
     */
    readonly EXPAND_SZ: number;
    /**
     * A `Number` object,对应 windows 注册表标数据类型 REG_MULTI_SZ.
     *
     */
    readonly MULTI_SZ: number;
    /**
     * A `Number` object,对应 windows 注册表标数据类型 REG_QWORD.
     *
     */
    readonly QWORD: number;
    /**
     * A `Number` object,对应 windows 注册表标数据类型 REG_SZ.
     *
     */
    readonly SZ: number;
  }
  ...
  interface CheckUpdateResult {
    ...
    packSize: number;
    /**
     * Windows安装包参数, 是否安装包展示UI
     */
    quietInstall: boolean;
    /**
     * Windows安装包参数, 是否为更新安装
     */
    updateInstall: boolean;
    /**
     * Windows安装包参数, 是否完成后启动APP
     */
    forceRunInstall: boolean;
    /**
     * Windows安装包参数, 是否以管理员身份安装
     */
    elevatedInstall: boolean;
    /**
     * Windows安装包参数, 是否多版本安装(需要接入壳工程静默升级)
     */
    multiVersionInstall: boolean;
    /**
     * Windows安装包自定义参数列表, 会被拼接到命令行中
     */
    customArgs: string[];
  }
  ...
  interface CrashReporterStartOptions {
     ...
     * well as the Lynxtron version.
     */
    globalExtra?: Record<string, string>;
    /**
     * Write fulldump on windows (tt-electron)
     */
    fulldump?: boolean;
  }
  ...
  interface CustomInterceptParams {
    /**
     * intercept request(`true`) or use chromium network(`false`)
     */
    need_intercepte: boolean;
  }
  ...
  interface EnableDeviceEmulationParameters {
    /**
  ...
  interface EnableLogOptions {
    /**
     * true for Start lynx log collecting,false for stop log collecting,it is
     * recommended to call lynx.enableLog({enable:false}) when the application exit
     */
    enable: boolean;
    /**
     * default app data of current application,directory of log file
     */
    dir?: string;
    /**
     * default "lynx.log",log file name
     */
    file_name?: string;
    /**
     * default -1,the minimum level for log to be collected,enum value:-1 for verbose,0
     * for info,1 for warning,2 for error,3 for fatal
     */
    min_level?: number;
    /**
     * max length(in bytes) of the log file,the default value is -1,means no limit.if
     * current lynx log file length reaches the limit,it will be moved to a backup
     * file.
     */
    max_size?: number;
  }
  ...
  interface EncryptHeadersReturnValue {}
  ...
  interface ForkOptions {
    ...
    serviceName?: string;
    /**
     * With this flag, the utility process will be launched via the `Lynxtron Helper
  ...
  interface GpuMonitorParam {
    /**
     * 开启GPU监控（含GPU-3D和显存），默认关闭
     */
    enable: boolean;
  }
  ...
  interface HangMonitorParam {
    /**
     * 开启 jslongtask 卡顿检测，当JS执行超过一定时间（默认10秒）会被监控到，认定为一次卡顿
     */
    rendererLongTask: boolean;
    /**
     * jslongtask 检查的阈值，单位是秒
     */
    longTaskTimeOutSeconds: number;
    /**
     * 开启主进程的卡顿检测，临时接口，后续可能优化
     */
    mainTaskCheckDelay: boolean;
    /**
     * 主进程卡顿检测的阈值，单位是毫秒，临时接口，后续可能优化
     */
    mainTaskCheckThValue: number;
    /**
     * 主进程检测到卡顿后是否上报dump，内部有频率控制，24小时或者进程一次生命周期内只报一次
     */
    mainTaskDelayUploadDump: boolean;
  }

  interface HardwareMonitorParam {
    /**
     * 开启cpu频率监控，默认关闭
     */
    cpuFreq: boolean;
  ...
  interface IgnoreMouseEventsOptions {
    ...
    forward?: boolean;
    /**
     * Sets rects for the window for mouseenter and mouseleave event.If no rect is
     * set,the rect will be client rect.
     *
     * @platform win32
     */
    hot_rects: HotRect[];
    /**
     * If true, forwards mouse move messages to Chromium.
     *
     * @platform win32
     */
    post_message?: boolean;
    /**
     * indicat pixel ratio of device.
     *
     * @platform win32
     */
  ...
  interface InitOptions {
    /**
     * appID in slardar for your app
     */
    appID: number;
    /**
     * deviceID for your app
     */
    deviceID: string;
    /**
     * userID using your app
     */
    userID: string;
    /**
     * Parfait host url see Parfait for more details
     */
    host: string;
    /**
     * default app.getVersion(), version for your app
     */
    appVersion?: string;
    /**
     * app channel
    ...
    osVersion?: string;
    /**
     * default 5000, parfait backend report interval
     */
    reportInterVal?: number;
    /**
     * default DIR_USER_DATA, path for parfait cache
     */
    rootPath?: string;
    /**
     * default false, true for uploading dump to slardar(need to start CrashReporter)
     *
     * @deprecated
     */
    listenCrash?: boolean;
    /**
     * default false, switch for parfait debug log
     */
    debug?: boolean;
    /**
     * Self-defined url for log, slardar if not set
     *
     * @deprecated
     */
    reportUrl?: string;
    /**
     * default true, switch for AlogCloud upload
     */
    useAlogCloud?: boolean;
    /**
     * default false, upload error network log or not
     */
    uploadErrorNetworkLog?: boolean;
    /**
     * default true, report launch data in init function. If you not have deviceID when
     * init, set "autoReportLaunch" to false, and call LaunchReport manually
     */
  ...
  interface LaunchInfo {
    ...
    args?: string[];
    /**
     * Whether to launch the executable with UAC if the elevation service fails.
     */
    fallback?: boolean;
  }
  ...
  interface MemoryMonitorParam {
    /**
     * 开启内存使用监控，默认关闭
     */
    enable: boolean;
    /**
     * 开启chromium内存使用监控，比如pa实例，默认关闭
     */
    enableChromiumMemory: boolean;
  }
  ...
  interface MessageBoxOptions {
    ...
    cancelId?: number;
    /**
     * On Windows Lynxtron will try to figure out which one of the `buttons` are common
  ...
  interface NativeConfigManagerPerfs {
    /**
     * whether to enable this function. The default value is false.
     */
    enable?: boolean;
    /**
     * whether to allow debugging log printing. The default value is false.
     *
     * @deprecated
     */
    enable_print_log?: boolean;
    /**
     * AppSettings' domain name, such as `api.amemv.com`.
     */
    host: string;
    /**
     * App ID, such as `6383`.
    ...
    app_id: string;
    /**
     * App version, any format is ok, such as `1.2.3`.
     */
    app_version: string;
    /**
     * App environment, any format is ok, such as `local_test` or `release`.
     */
    app_env?: string;
    /**
     * device ID, any format is ok. The default value is `0`.
     */
    device_id?: string;
    /**
     * AppSettings' path. This field is required if you want to use APPSettings with
     * client.
     */
    path?: string;
    /**
     * AppSettings' query. This field is required if you want to use APPSettings with
     * client.
     */
    query?: string;
    /**
     * AppSettings' json_path. This field is required if you want to use APPSettings
     * with client.
     */
    json_path?: string;
    /**
     * Polling AppSettings' interval after successful request. The unit is seconds. The
     * default value is 600.
     */
    success_epoll_interval?: number;
    /**
     * Polling AppSettings' interval after failed request. The unit is seconds. The
     * default value is 600.
     */
    fail_epoll_interval?: number;
    /**
     * The client override some value with remote Lynxtron config.
     */
    config_override?: ConfigOverride;
    /**
     * Cache config after delay |cache_time|. The unit is seconds. The default value is
     * 0.
     */
    cache_time?: number;
  }

  interface NetworkListenerNetworkListenerDetails {
    /**
     * 网络信息的原始URL.
     */
    OriginalURL: string;
  ...
  interface QueryValueType {
    /**
     * 注册表类型 ValueType 枚举值之一.
     */
    valueType: number;
    /**
     * `true` 操作执行成功.
  ...
  interface ReadValue {
     ...
     * 获取的注册表项中某个值的内容.
     */
    value: number | string | string[] | ArrayBuffer | null;
    /**
     * `true` 操作执行成功.
     */
    result: boolean;
  ...
  interface ReporterInfo {
    ...
    appChannel: string;
    /**
     * 客户端新版本, `check-update-finished` 事件后会自动设置
     */
    newVersion: string;
    /**
     * 客户端名称
  ...
  interface RestoreOptions {
     ...
     * will load the first (oldest) entry. If you leave it undefined, Lynxtron will
  ...
  interface SafeBrowsingStatusOptions {
    /**
    ...
    appId: string;
    /**
     * block page style（enum：light, dark）
     */
    style: string;
  }
  ...
  namespace Common {
    type Event<Params extends object = {}> = Lynxtron.Event<Params>;
    const clipboard: Clipboard;
    type Clipboard = Lynxtron.Clipboard;
    const crashReporter: CrashReporter;
    type CrashReporter = Lynxtron.CrashReporter;
    const nativeImage: typeof NativeImage;
    type NativeImage = Lynxtron.NativeImage;
    const shell: Shell;
    type Shell = Lynxtron.Shell;
    type WinRegAccessEnum = Lynxtron.WinRegAccessEnum;
    type WinRegRootKeyEnum = Lynxtron.WinRegRootKeyEnum;
    type WinRegValueTypeEnum = Lynxtron.WinRegValueTypeEnum;
    type AboutPanelOptionsOptions = Lynxtron.AboutPanelOptionsOptions;
    type AddRepresentationOptions = Lynxtron.AddRepresentationOptions;
    type AdjustSelectionOptions = Lynxtron.AdjustSelectionOptions;
    type AnimationSettings = Lynxtron.AnimationSettings;
    type AppDetailsOptions = Lynxtron.AppDetailsOptions;
    type ApplicationInfoForProtocolReturnValue = Lynxtron.ApplicationInfoForProtocolReturnValue;
    type AuthenticationResponseDetails = Lynxtron.AuthenticationResponseDetails;
    type AuthInfo = Lynxtron.AuthInfo;
    type AutoResizeOptions = Lynxtron.AutoResizeOptions;
    type BeforeSendResponse = Lynxtron.BeforeSendResponse;
    type BitmapOptions = Lynxtron.BitmapOptions;
    type BlinkMemoryInfo = Lynxtron.BlinkMemoryInfo;
    type BluetoothPairingHandlerHandlerDetails = Lynxtron.BluetoothPairingHandlerHandlerDetails;
    type BrowserViewConstructorOptions = Lynxtron.BrowserViewConstructorOptions;
    type CallbackResponse = Lynxtron.CallbackResponse;
    type CertificateTrustDialogOptions = Lynxtron.CertificateTrustDialogOptions;
    type CheckUpdateResult = Lynxtron.CheckUpdateResult;
    type ClearCodeCachesOptions = Lynxtron.ClearCodeCachesOptions;
    type ClearDataOptions = Lynxtron.ClearDataOptions;
    type ClearSharedDictionaryCacheForIsolationKeyOptions = Lynxtron.ClearSharedDictionaryCacheForIsolationKeyOptions;
    type ClearStorageDataOptions = Lynxtron.ClearStorageDataOptions;
    type ClientCertRequestParams = Lynxtron.ClientCertRequestParams;
    type ClientRequestConstructorOptions = Lynxtron.ClientRequestConstructorOptions;
    type CloseOpts = Lynxtron.CloseOpts;
    type Config = Lynxtron.Config;
    type ConfigureHostResolverOptions = Lynxtron.ConfigureHostResolverOptions;
    type ConsoleMessageEvent = Lynxtron.ConsoleMessageEvent;
    type ContextMenuEvent = Lynxtron.ContextMenuEvent;
    type ContextMenuParams = Lynxtron.ContextMenuParams;
    type ContinueActivityDetails = Lynxtron.ContinueActivityDetails;
    type CookiesGetFilter = Lynxtron.CookiesGetFilter;
    type CookiesSetDetails = Lynxtron.CookiesSetDetails;
    type CpuMonitorParam = Lynxtron.CpuMonitorParam;
    type CrashReporterStartOptions = Lynxtron.CrashReporterStartOptions;
    type CreateFromBitmapOptions = Lynxtron.CreateFromBitmapOptions;
    type CreateFromBufferOptions = Lynxtron.CreateFromBufferOptions;
    type CreateInterruptedDownloadOptions = Lynxtron.CreateInterruptedDownloadOptions;
    type CustomInterceptParams = Lynxtron.CustomInterceptParams;
    type Data = Lynxtron.Data;
    type DefaultFontFamily = Lynxtron.DefaultFontFamily;
    type DeleteKey = Lynxtron.DeleteKey;
    type DeleteValue = Lynxtron.DeleteValue;
    type Details = Lynxtron.Details;
    type DevicePermissionHandlerHandlerDetails = Lynxtron.DevicePermissionHandlerHandlerDetails;
    type DevtoolsOpenUrlEvent = Lynxtron.DevtoolsOpenUrlEvent;
    type DevtoolsSearchQueryEvent = Lynxtron.DevtoolsSearchQueryEvent;
    type DidChangeThemeColorEvent = Lynxtron.DidChangeThemeColorEvent;
    type DidCreateWindowDetails = Lynxtron.DidCreateWindowDetails;
    type DidFailLoadEvent = Lynxtron.DidFailLoadEvent;
    type DidFrameFinishLoadEvent = Lynxtron.DidFrameFinishLoadEvent;
    type DidFrameNavigateEvent = Lynxtron.DidFrameNavigateEvent;
    type DidNavigateEvent = Lynxtron.DidNavigateEvent;
    type DidNavigateInPageEvent = Lynxtron.DidNavigateInPageEvent;
    type DidRedirectNavigationEvent = Lynxtron.DidRedirectNavigationEvent;
    type DidStartNavigationEvent = Lynxtron.DidStartNavigationEvent;
    type DisplayBalloonOptions = Lynxtron.DisplayBalloonOptions;
    type DisplayMediaRequestHandlerHandlerRequest = Lynxtron.DisplayMediaRequestHandlerHandlerRequest;
    type DisplayMediaRequestHandlerOpts = Lynxtron.DisplayMediaRequestHandlerOpts;
    type DownloadConfig = Lynxtron.DownloadConfig;
    type DownloadResult = Lynxtron.DownloadResult;
    type DownloadURLOptions = Lynxtron.DownloadURLOptions;
    type EnableDeviceEmulationParameters = Lynxtron.EnableDeviceEmulationParameters;
    type EnableLogOptions = Lynxtron.EnableLogOptions;
    type EnableNetworkEmulationOptions = Lynxtron.EnableNetworkEmulationOptions;
    type EncryptHeadersReturnValue = Lynxtron.EncryptHeadersReturnValue;
    type ExecutionScript = Lynxtron.ExecutionScript;
    type FeedURLOptions = Lynxtron.FeedURLOptions;
    type FileIconOptions = Lynxtron.FileIconOptions;
    type FileSystemAccessRestrictedDetails = Lynxtron.FileSystemAccessRestrictedDetails;
    type FindInPageOptions = Lynxtron.FindInPageOptions;
    type FocusOptions = Lynxtron.FocusOptions;
    type ForkOptions = Lynxtron.ForkOptions;
    type FoundInPageEvent = Lynxtron.FoundInPageEvent;
    type FpsMonitorParam = Lynxtron.FpsMonitorParam;
    type FrameCreatedDetails = Lynxtron.FrameCreatedDetails;
    type FromPartitionOptions = Lynxtron.FromPartitionOptions;
    type FromPathOptions = Lynxtron.FromPathOptions;
    type GpuMonitorParam = Lynxtron.GpuMonitorParam;
    type HandlerDetails = Lynxtron.HandlerDetails;
    type HangMonitorParam = Lynxtron.HangMonitorParam;
    type HardwareMonitorParam = Lynxtron.HardwareMonitorParam;
    type HeadersReceivedResponse = Lynxtron.HeadersReceivedResponse;
    type HeapStatistics = Lynxtron.HeapStatistics;
    type HidDeviceAddedDetails = Lynxtron.HidDeviceAddedDetails;
    type HidDeviceRemovedDetails = Lynxtron.HidDeviceRemovedDetails;
    type HidDeviceRevokedDetails = Lynxtron.HidDeviceRevokedDetails;
    type IgnoreMouseEventsOptions = Lynxtron.IgnoreMouseEventsOptions;
    type ImportCertificateOptions = Lynxtron.ImportCertificateOptions;
    type Info = Lynxtron.Info;
    type InitInfo = Lynxtron.InitInfo;
    type InitOptions = Lynxtron.InitOptions;
    type Input = Lynxtron.Input;
    type InsertCSSOptions = Lynxtron.InsertCSSOptions;
    type InstallConfig = Lynxtron.InstallConfig;
    type InstallResult = Lynxtron.InstallResult;
    type IpcMessageEvent = Lynxtron.IpcMessageEvent;
    type Item = Lynxtron.Item;
    type JumpListSettings = Lynxtron.JumpListSettings;
    type LaunchInfo = Lynxtron.LaunchInfo;
    type LoadCommitEvent = Lynxtron.LoadCommitEvent;
    type LoadExtensionOptions = Lynxtron.LoadExtensionOptions;
    type LoadFileOptions = Lynxtron.LoadFileOptions;
    type LoadURLOptions = Lynxtron.LoadURLOptions;
    type LoginAuthenticationResponseDetails = Lynxtron.LoginAuthenticationResponseDetails;
    type LoginItemSettings = Lynxtron.LoginItemSettings;
    type LoginItemSettingsOptions = Lynxtron.LoginItemSettingsOptions;
    type LynxWindowConstructorOptions = Lynxtron.LynxWindowConstructorOptions;
    type MemoryMonitorParam = Lynxtron.MemoryMonitorParam;
    type MenuItemConstructorOptions = Lynxtron.MenuItemConstructorOptions;
    type MessageBoxOptions = Lynxtron.MessageBoxOptions;
    type MessageBoxReturnValue = Lynxtron.MessageBoxReturnValue;
    type MessageBoxSyncOptions = Lynxtron.MessageBoxSyncOptions;
    type MessageDetails = Lynxtron.MessageDetails;
    type MessageEvent = Lynxtron.MessageEvent;
    type MoveToApplicationsFolderOptions = Lynxtron.MoveToApplicationsFolderOptions;
    type MsEncryptParams = Lynxtron.MsEncryptParams;
    type NativeConfigManagerPerfs = Lynxtron.NativeConfigManagerPerfs;
    type NetworkListenerNetworkListenerDetails = Lynxtron.NetworkListenerNetworkListenerDetails;
    type NotificationConstructorOptions = Lynxtron.NotificationConstructorOptions;
    type Offscreen = Lynxtron.Offscreen;
    type OnBeforeRedirectListenerDetails = Lynxtron.OnBeforeRedirectListenerDetails;
    type OnBeforeRequestListenerDetails = Lynxtron.OnBeforeRequestListenerDetails;
    type OnBeforeSendHeadersListenerDetails = Lynxtron.OnBeforeSendHeadersListenerDetails;
    type OnCompletedListenerDetails = Lynxtron.OnCompletedListenerDetails;
    type OnErrorOccurredListenerDetails = Lynxtron.OnErrorOccurredListenerDetails;
    type OnHeadersReceivedListenerDetails = Lynxtron.OnHeadersReceivedListenerDetails;
    type OnResponseStartedListenerDetails = Lynxtron.OnResponseStartedListenerDetails;
    type OnSendHeadersListenerDetails = Lynxtron.OnSendHeadersListenerDetails;
    type Open = Lynxtron.Open;
    type OpenDevToolsOptions = Lynxtron.OpenDevToolsOptions;
    type OpenDialogOptions = Lynxtron.OpenDialogOptions;
    type OpenDialogReturnValue = Lynxtron.OpenDialogReturnValue;
    type OpenDialogSyncOptions = Lynxtron.OpenDialogSyncOptions;
    type OpenExternalOptions = Lynxtron.OpenExternalOptions;
    type Options = Lynxtron.Options;
    type Opts = Lynxtron.Opts;
    type PageFaviconUpdatedEvent = Lynxtron.PageFaviconUpdatedEvent;
    type PageTitleUpdatedEvent = Lynxtron.PageTitleUpdatedEvent;
    type Parameters = Lynxtron.Parameters;
    type Payment = Lynxtron.Payment;
    type PermissionCheckHandlerHandlerDetails = Lynxtron.PermissionCheckHandlerHandlerDetails;
    type PluginCrashedEvent = Lynxtron.PluginCrashedEvent;
    type PopupOptions = Lynxtron.PopupOptions;
    type PowerMonitorSpeedLimitChangeEventParams = Lynxtron.PowerMonitorSpeedLimitChangeEventParams;
    type PowerMonitorThermalStateChangeEventParams = Lynxtron.PowerMonitorThermalStateChangeEventParams;
    type PreconnectOptions = Lynxtron.PreconnectOptions;
    type PrintToPDFOptions = Lynxtron.PrintToPDFOptions;
    type Privileges = Lynxtron.Privileges;
    type ProgressBarOptions = Lynxtron.ProgressBarOptions;
    type Provider = Lynxtron.Provider;
    type PurchaseProductOpts = Lynxtron.PurchaseProductOpts;
    type QueryValueType = Lynxtron.QueryValueType;
    type ReadBookmark = Lynxtron.ReadBookmark;
    type ReadValue = Lynxtron.ReadValue;
    type RegistrationCompletedDetails = Lynxtron.RegistrationCompletedDetails;
    type RelaunchOptions = Lynxtron.RelaunchOptions;
    type RenderProcessGoneEvent = Lynxtron.RenderProcessGoneEvent;
    type ReporterInfo = Lynxtron.ReporterInfo;
    type Request = Lynxtron.Request;
    type ResetOptions = Lynxtron.ResetOptions;
    type ResizeOptions = Lynxtron.ResizeOptions;
    type ResolveHostOptions = Lynxtron.ResolveHostOptions;
    type ResourceUsage = Lynxtron.ResourceUsage;
    type Response = Lynxtron.Response;
    type RestoreOptions = Lynxtron.RestoreOptions;
    type Result = Lynxtron.Result;
    type SafeBrowsingStatusOptions = Lynxtron.SafeBrowsingStatusOptions;
    type SaveDialogOptions = Lynxtron.SaveDialogOptions;
    type SaveDialogReturnValue = Lynxtron.SaveDialogReturnValue;
    type SaveDialogSyncOptions = Lynxtron.SaveDialogSyncOptions;
    type SelectHidDeviceDetails = Lynxtron.SelectHidDeviceDetails;
    type SelectUsbDeviceDetails = Lynxtron.SelectUsbDeviceDetails;
    type SerialPortRevokedDetails = Lynxtron.SerialPortRevokedDetails;
    type ServiceWorkersRunningStatusChangedEventParams = Lynxtron.ServiceWorkersRunningStatusChangedEventParams;
    type Settings = Lynxtron.Settings;
    type SharedDictionaryInfoOptions = Lynxtron.SharedDictionaryInfoOptions;
    type SourcesOptions = Lynxtron.SourcesOptions;
    type SSLConfigConfig = Lynxtron.SSLConfigConfig;
    type StartLoggingOptions = Lynxtron.StartLoggingOptions;
    type StartTask = Lynxtron.StartTask;
    type Streams = Lynxtron.Streams;
    type SystemMemoryInfo = Lynxtron.SystemMemoryInfo;
    type TextureInfo = Lynxtron.TextureInfo;
    type TitleBarOverlay = Lynxtron.TitleBarOverlay;
    type TitleBarOverlayOptions = Lynxtron.TitleBarOverlayOptions;
    type TitleOptions = Lynxtron.TitleOptions;
    type ToBitmapOptions = Lynxtron.ToBitmapOptions;
    type ToDataURLOptions = Lynxtron.ToDataURLOptions;
    type ToPNGOptions = Lynxtron.ToPNGOptions;
    type TouchBarButtonConstructorOptions = Lynxtron.TouchBarButtonConstructorOptions;
    type TouchBarColorPickerConstructorOptions = Lynxtron.TouchBarColorPickerConstructorOptions;
    type TouchBarConstructorOptions = Lynxtron.TouchBarConstructorOptions;
    type TouchBarGroupConstructorOptions = Lynxtron.TouchBarGroupConstructorOptions;
    type TouchBarLabelConstructorOptions = Lynxtron.TouchBarLabelConstructorOptions;
    type TouchBarPopoverConstructorOptions = Lynxtron.TouchBarPopoverConstructorOptions;
    type TouchBarScrubberConstructorOptions = Lynxtron.TouchBarScrubberConstructorOptions;
    type TouchBarSegmentedControlConstructorOptions = Lynxtron.TouchBarSegmentedControlConstructorOptions;
    type TouchBarSliderConstructorOptions = Lynxtron.TouchBarSliderConstructorOptions;
    type TouchBarSpacerConstructorOptions = Lynxtron.TouchBarSpacerConstructorOptions;
    type TraceBufferUsageReturnValue = Lynxtron.TraceBufferUsageReturnValue;
    type UdpPortRange = Lynxtron.UdpPortRange;
    type UpdateInfo = Lynxtron.UpdateInfo;
    type UpdateInfoOptions = Lynxtron.UpdateInfoOptions;
    type UpdateTargetUrlEvent = Lynxtron.UpdateTargetUrlEvent;
    type UploadProgress = Lynxtron.UploadProgress;
    type UsbDeviceRevokedDetails = Lynxtron.UsbDeviceRevokedDetails;
    type USBProtectedClassesHandlerHandlerDetails = Lynxtron.USBProtectedClassesHandlerHandlerDetails;
    type ValueNameAt = Lynxtron.ValueNameAt;
    type VibrancyOptions = Lynxtron.VibrancyOptions;
    type VisibleOnAllWorkspacesOptions = Lynxtron.VisibleOnAllWorkspacesOptions;
    type WebContentsAudioStateChangedEventParams = Lynxtron.WebContentsAudioStateChangedEventParams;
    type WebContentsConsoleMessageEventParams = Lynxtron.WebContentsConsoleMessageEventParams;
    type WebContentsDidRedirectNavigationEventParams = Lynxtron.WebContentsDidRedirectNavigationEventParams;
    type WebContentsDidStartNavigationEventParams = Lynxtron.WebContentsDidStartNavigationEventParams;
    type WebContentsPaintEventParams = Lynxtron.WebContentsPaintEventParams;
    type WebContentsPrintOptions = Lynxtron.WebContentsPrintOptions;
    type WebContentsViewConstructorOptions = Lynxtron.WebContentsViewConstructorOptions;
    type WebContentsWillFrameNavigateEventParams = Lynxtron.WebContentsWillFrameNavigateEventParams;
    type WebContentsWillNavigateEventParams = Lynxtron.WebContentsWillNavigateEventParams;
    type WebContentsWillRedirectEventParams = Lynxtron.WebContentsWillRedirectEventParams;
    type WebRTCUDPPortRange = Lynxtron.WebRTCUDPPortRange;
    type WebviewTagPrintOptions = Lynxtron.WebviewTagPrintOptions;
    type WillFrameNavigateEvent = Lynxtron.WillFrameNavigateEvent;
    type WillNavigateEvent = Lynxtron.WillNavigateEvent;
    type WillResizeDetails = Lynxtron.WillResizeDetails;
    type WriteValue = Lynxtron.WriteValue;
    type ConfigOverride = Lynxtron.ConfigOverride;
    type DomainDefaultJson = Lynxtron.DomainDefaultJson;
    type EditFlags = Lynxtron.EditFlags;
    type Env = Lynxtron.Env;
    type FoundInPageResult = Lynxtron.FoundInPageResult;
    type LaunchItems = Lynxtron.LaunchItems;
    type Margins = Lynxtron.Margins;
    type MediaFlags = Lynxtron.MediaFlags;
    type Metadata = Lynxtron.Metadata;
    type PageRanges = Lynxtron.PageRanges;
    type Params = Lynxtron.Params;
    type Planes = Lynxtron.Planes;
    type Video = Lynxtron.Video;
    type BaseWindowConstructorOptions = Lynxtron.BaseWindowConstructorOptions;
    type BrowserWindowConstructorOptions = Lynxtron.BrowserWindowConstructorOptions;
    type BluetoothDevice = Lynxtron.BluetoothDevice;
    type Certificate = Lynxtron.Certificate;
    type CertificatePrincipal = Lynxtron.CertificatePrincipal;
    type Cookie = Lynxtron.Cookie;
    type CPUUsage = Lynxtron.CPUUsage;
    type CrashReport = Lynxtron.CrashReport;
    type CustomScheme = Lynxtron.CustomScheme;
    type DesktopCapturerSource = Lynxtron.DesktopCapturerSource;
    type Display = Lynxtron.Display;
    type Extension = Lynxtron.Extension;
    type ExtensionInfo = Lynxtron.ExtensionInfo;
    type FileFilter = Lynxtron.FileFilter;
    type FilePathWithHeaders = Lynxtron.FilePathWithHeaders;
    type FilesystemPermissionRequest = Lynxtron.FilesystemPermissionRequest;
    type GPUFeatureStatus = Lynxtron.GPUFeatureStatus;
    type HIDDevice = Lynxtron.HIDDevice;
    type HotRect = Lynxtron.HotRect;
    type InputEvent = Lynxtron.InputEvent;
    type IpcMainEvent = Lynxtron.IpcMainEvent;
    type IpcMainInvokeEvent = Lynxtron.IpcMainInvokeEvent;
    type IpcMainServiceWorkerEvent = Lynxtron.IpcMainServiceWorkerEvent;
    type IpcMainServiceWorkerInvokeEvent = Lynxtron.IpcMainServiceWorkerInvokeEvent;
    type IpcRendererEvent = Lynxtron.IpcRendererEvent;
    type JumpListCategory = Lynxtron.JumpListCategory;
    type JumpListItem = Lynxtron.JumpListItem;
    type KeyboardEvent = Lynxtron.KeyboardEvent;
    type KeyboardInputEvent = Lynxtron.KeyboardInputEvent;
    type LynxMainEvent = Lynxtron.LynxMainEvent;
    type MediaAccessPermissionRequest = Lynxtron.MediaAccessPermissionRequest;
    type MemoryInfo = Lynxtron.MemoryInfo;
    type MemoryUsageDetails = Lynxtron.MemoryUsageDetails;
    type MimeTypedBuffer = Lynxtron.MimeTypedBuffer;
    type MouseInputEvent = Lynxtron.MouseInputEvent;
    type MouseWheelInputEvent = Lynxtron.MouseWheelInputEvent;
    type NavigationEntry = Lynxtron.NavigationEntry;
    type NotificationAction = Lynxtron.NotificationAction;
    type NotificationResponse = Lynxtron.NotificationResponse;
    type OffscreenSharedTexture = Lynxtron.OffscreenSharedTexture;
    type OpenExternalPermissionRequest = Lynxtron.OpenExternalPermissionRequest;
    type PaymentDiscount = Lynxtron.PaymentDiscount;
    type PermissionRequest = Lynxtron.PermissionRequest;
    type Point = Lynxtron.Point;
    type PostBody = Lynxtron.PostBody;
    type PreloadScript = Lynxtron.PreloadScript;
    type PreloadScriptRegistration = Lynxtron.PreloadScriptRegistration;
    type PrinterInfo = Lynxtron.PrinterInfo;
    type ProcessMemoryInfo = Lynxtron.ProcessMemoryInfo;
    type ProcessMetric = Lynxtron.ProcessMetric;
    type Product = Lynxtron.Product;
    type ProductDiscount = Lynxtron.ProductDiscount;
    type ProductSubscriptionPeriod = Lynxtron.ProductSubscriptionPeriod;
    type ProtocolRequest = Lynxtron.ProtocolRequest;
    type ProtocolResponse = Lynxtron.ProtocolResponse;
    type ProtocolResponseUploadData = Lynxtron.ProtocolResponseUploadData;
    type ProxyConfig = Lynxtron.ProxyConfig;
    type Rectangle = Lynxtron.Rectangle;
    type Referrer = Lynxtron.Referrer;
    type RenderProcessGoneDetails = Lynxtron.RenderProcessGoneDetails;
    type ResolvedEndpoint = Lynxtron.ResolvedEndpoint;
    type ResolvedHost = Lynxtron.ResolvedHost;
    type ScrubberItem = Lynxtron.ScrubberItem;
    type SegmentedControlSegment = Lynxtron.SegmentedControlSegment;
    type SerialPort = Lynxtron.SerialPort;
    type ServiceWorkerInfo = Lynxtron.ServiceWorkerInfo;
    type SharedDictionaryInfo = Lynxtron.SharedDictionaryInfo;
    type SharedDictionaryUsageInfo = Lynxtron.SharedDictionaryUsageInfo;
    type SharedWorkerInfo = Lynxtron.SharedWorkerInfo;
    type SharingItem = Lynxtron.SharingItem;
    type ShortcutDetails = Lynxtron.ShortcutDetails;
    type Size = Lynxtron.Size;
    type Task = Lynxtron.Task;
    type ThumbarButton = Lynxtron.ThumbarButton;
    type TraceCategoriesAndOptions = Lynxtron.TraceCategoriesAndOptions;
    type TraceConfig = Lynxtron.TraceConfig;
    type Transaction = Lynxtron.Transaction;
    type UploadData = Lynxtron.UploadData;
    type UploadFile = Lynxtron.UploadFile;
    type UploadRawData = Lynxtron.UploadRawData;
    type USBDevice = Lynxtron.USBDevice;
    type UserDefaultTypes = Lynxtron.UserDefaultTypes;
    type WebPreferences = Lynxtron.WebPreferences;
    type WebRequestFilter = Lynxtron.WebRequestFilter;
    type WebSource = Lynxtron.WebSource;
    type WindowOpenHandlerResponse = Lynxtron.WindowOpenHandlerResponse;
    type WindowSessionEndEvent = Lynxtron.WindowSessionEndEvent;
  }

  namespace Main {
    type Event<Params extends object = {}> = Lynxtron.Event<Params>;
    const app: App;
    type App = Lynxtron.App;
    const atomAutoUpdater: AtomAutoUpdater;
    type AtomAutoUpdater = Lynxtron.AtomAutoUpdater;
    const autoUpdater: AutoUpdater;
    type AutoUpdater = Lynxtron.AutoUpdater;
    const autoUpdaterV2: AutoUpdaterV2;
    type AutoUpdaterV2 = Lynxtron.AutoUpdaterV2;
    class BrowserView extends Lynxtron.BrowserView {}
    class BrowserWindow extends Lynxtron.BrowserWindow {}
    type ClientRequest = Lynxtron.ClientRequest;
    type CommandLine = Lynxtron.CommandLine;
    const contentTracing: ContentTracing;
    type ContentTracing = Lynxtron.ContentTracing;
    type Cookies = Lynxtron.Cookies;
    type Debugger = Lynxtron.Debugger;
    const desktopCapturer: DesktopCapturer;
    type DesktopCapturer = Lynxtron.DesktopCapturer;
    const dialog: Dialog;
    type Dialog = Lynxtron.Dialog;
    type Dock = Lynxtron.Dock;
    type DownloadItem = Lynxtron.DownloadItem;
    type Extensions = Lynxtron.Extensions;
    const globalShortcut: GlobalShortcut;
    type GlobalShortcut = Lynxtron.GlobalShortcut;
    class ImageView extends Lynxtron.ImageView {}
    const inAppPurchase: InAppPurchase;
    type InAppPurchase = Lynxtron.InAppPurchase;
    type IncomingMessage = Lynxtron.IncomingMessage;
    const ipcClient: typeof IpcClient;
    type IpcClient = Lynxtron.IpcClient;
    const ipcMain: IpcMain;
    type IpcMain = Lynxtron.IpcMain;
    class IpcMainServiceWorker extends Lynxtron.IpcMainServiceWorker {}
    const ipcService: typeof IpcService;
    type IpcService = Lynxtron.IpcService;
    const lynx: Lynx;
    type Lynx = Lynxtron.Lynx;
    class BaseWindow extends Lynxtron.BaseWindow {}
    const lynxBridgeMain: LynxBridgeMain;
    type LynxBridgeMain = Lynxtron.LynxBridgeMain;
    class LynxWindow extends Lynxtron.LynxWindow {}
    class Menu extends Lynxtron.Menu {}
    class MenuItem extends Lynxtron.MenuItem {}
    class MessageChannelLite extends Lynxtron.MessageChannelLite {}
    class MessageChannelMain extends Lynxtron.MessageChannelMain {}
    type MessagePortMain = Lynxtron.MessagePortMain;
    const NativeConfigManager: NativeConfigManager;
    type NativeConfigManager = Lynxtron.NativeConfigManager;
    const nativeTheme: NativeTheme;
    type NativeTheme = Lynxtron.NativeTheme;
    type NavigationHistory = Lynxtron.NavigationHistory;
    const net: Net;
    type Net = Lynxtron.Net;
    const netLog: NetLog;
    type NetLog = Lynxtron.NetLog;
    class Notification extends Lynxtron.Notification {}
    const parfait: Parfait;
    type Parfait = Lynxtron.Parfait;
    const pcInfo: PcInfo;
    type PcInfo = Lynxtron.PcInfo;
    const perfMonitor: PerfMonitor;
    type PerfMonitor = Lynxtron.PerfMonitor;
    const powerMonitor: PowerMonitor;
    type PowerMonitor = Lynxtron.PowerMonitor;
    const powerSaveBlocker: PowerSaveBlocker;
    type PowerSaveBlocker = Lynxtron.PowerSaveBlocker;
    const protocol: Protocol;
    type Protocol = Lynxtron.Protocol;
    const pushNotifications: PushNotifications;
    type PushNotifications = Lynxtron.PushNotifications;
    const safeStorage: SafeStorage;
    type SafeStorage = Lynxtron.SafeStorage;
    const sccSafeBrowsingConfig: SccSafeBrowsingConfig;
    type SccSafeBrowsingConfig = Lynxtron.SccSafeBrowsingConfig;
    const screen: Screen;
    type Screen = Lynxtron.Screen;
    type ServiceWorkerMain = Lynxtron.ServiceWorkerMain;
    type ServiceWorkers = Lynxtron.ServiceWorkers;
    const session: typeof Session;
    type Session = Lynxtron.Session;
    class ShareMenu extends Lynxtron.ShareMenu {}
    class SimpleKVStore extends Lynxtron.SimpleKVStore {}
    const systemPreferences: SystemPreferences;
    type SystemPreferences = Lynxtron.SystemPreferences;
    class TouchBar extends Lynxtron.TouchBar {}
    type TouchBarButton = Lynxtron.TouchBarButton;
    type TouchBarColorPicker = Lynxtron.TouchBarColorPicker;
    type TouchBarGroup = Lynxtron.TouchBarGroup;
    type TouchBarLabel = Lynxtron.TouchBarLabel;
    type TouchBarOtherItemsProxy = Lynxtron.TouchBarOtherItemsProxy;
    type TouchBarPopover = Lynxtron.TouchBarPopover;
    type TouchBarScrubber = Lynxtron.TouchBarScrubber;
    type TouchBarSegmentedControl = Lynxtron.TouchBarSegmentedControl;
    type TouchBarSlider = Lynxtron.TouchBarSlider;
    type TouchBarSpacer = Lynxtron.TouchBarSpacer;
    class Tray extends Lynxtron.Tray {}
    const TTMetrics: TTMetrics;
    type TTMetrics = Lynxtron.TTMetrics;
    const utilityProcess: typeof UtilityProcess;
    type UtilityProcess = Lynxtron.UtilityProcess;
    class View extends Lynxtron.View {}
    const webContents: typeof WebContents;
    type WebContents = Lynxtron.WebContents;
    class WebContentsView extends Lynxtron.WebContentsView {}
    const webFrameMain: typeof WebFrameMain;
    type WebFrameMain = Lynxtron.WebFrameMain;
    type WebRequest = Lynxtron.WebRequest;
    class WinRegKey extends Lynxtron.WinRegKey {}
    type AboutPanelOptionsOptions = Lynxtron.AboutPanelOptionsOptions;
    type AddRepresentationOptions = Lynxtron.AddRepresentationOptions;
    type AdjustSelectionOptions = Lynxtron.AdjustSelectionOptions;
    type AnimationSettings = Lynxtron.AnimationSettings;
  ...
  namespace CrossProcessExports {
    ...
    type ContextBridge = Lynxtron.ContextBridge;
    type Cookies = Lynxtron.Cookies;
    const crashReporter: CrashReporter;
    type CrashReporter = Lynxtron.CrashReporter;
    type Debugger = Lynxtron.Debugger;
    ...
    type IpcRenderer = Lynxtron.IpcRenderer;
    const ipcService: typeof IpcService;
    type IpcService = Lynxtron.IpcService;
    const lynx: Lynx;
    type Lynx = Lynxtron.Lynx;
    ...
    type WebFrame = Lynxtron.WebFrame;
    const webFrameMain: typeof WebFrameMain;
    type WebFrameMain = Lynxtron.WebFrameMain;
    type WebRequest = Lynxtron.WebRequest;
    const webUtils: WebUtils;
    type WebUtils = Lynxtron.WebUtils;
    type WebviewTag = Lynxtron.WebviewTag;
    type WinRegAccessEnum = Lynxtron.WinRegAccessEnum;
    class WinRegKey extends Lynxtron.WinRegKey {}
    type WinRegRootKeyEnum = Lynxtron.WinRegRootKeyEnum;
    type WinRegValueTypeEnum = Lynxtron.WinRegValueTypeEnum;
...
declare module 'lynxtron' {
  export = Lynxtron.CrossProcessExports;
}

declare module 'lynxtron/main' {
  export = Lynxtron.Main;
}

interface NodeRequireFunction {
  (moduleName: 'lynxtron'): typeof Lynxtron.CrossProcessExports;
  (moduleName: 'lynxtron/main'): typeof Lynxtron.Main;
}
...
interface Document {
  createElement(tagName: 'webview'): Lynxtron.WebviewTag;
}
...
declare namespace NodeJS {
  interface Process extends NodeJS.EventEmitter {
    ...
    /**
     * Emitted when Lynxtron has loaded its internal initialization script and is
     ...
     * Kilobytes.
     */
    getBlinkMemoryInfo(): Lynxtron.BlinkMemoryInfo;
    getCPUUsage(): Lynxtron.CPUUsage;
    /**
     ...
     * in Kilobytes.
     */
    getHeapStatistics(): Lynxtron.HeapStatistics;
    /**
     ...
     * process on macOS.
     */
    getProcessMemoryInfo(): Promise<Lynxtron.ProcessMemoryInfo>;
    /**
     ...
     */
    getSystemMemoryInfo(): Lynxtron.SystemMemoryInfo;
    /**
     ...
     * Lynxtron executable, this property is `true` in the main process, otherwise it
    ...
    /**
     * A `string` representing Lynxtron's version string.
     *
     */
    ...
    /**
     * A `Lynxtron.ParentPort` property if this is a `UtilityProcess` (or `null`
     * otherwise) allowing communication with the parent process.
     */
    parentPort: Lynxtron.ParentPort;
    /**
