...
#ifndef PLUGIN_CEF_CEF_WEBVIEW_H_
#define PLUGIN_CEF_CEF_WEBVIEW_H_
...
#include "lynx/platform/embedder/public/lynx_native_view.h"
...
class CEFWebview : public lynx::pub::LynxNativeView {
 public:
  CEFWebview(lynx_view_t* lynx_view) : lynx_view_(lynx_view) {}
  ...
  virtual void OnMouseWheelEvent(int x,
                                 int y,
                                 int modifiers,
                                 double delta_x,
                                 double delta_y) {}
...
#endif  // PLUGIN_CEF_CEF_WEBVIEW_H_
