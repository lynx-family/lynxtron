...
bool DrawConsumerWidgetElementTextureSurface(
...
class ConsumerWidgetElementTextureView : public ConsumerWidgetElementView {
 public:
  explicit ConsumerWidgetElementTextureView(void* opaque)
 ...
 private:
  ...
  void Render() {
    ...
    if (DrawConsumerWidgetElementTextureSurface(
            surface,
            width_px_,
            height_px_,
            value().c_str())) {
...
lynx_native_view_t* CreateConsumerWidgetElementTextureNativeView(void* opaque) {
  auto* view = new ConsumerWidgetElementTextureView(opaque);
