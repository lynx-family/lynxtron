...
#ifndef LYNXTRON_SHELL_LYNX_VIEW_HOLDER_MODULE_LYNX_EMIT_EVENT_H_
#define LYNXTRON_SHELL_LYNX_VIEW_HOLDER_MODULE_LYNX_EMIT_EVENT_H_
...
#endif  // LYNXTRON_SHELL_LYNX_VIEW_HOLDER_MODULE_LYNX_EMIT_EVENT_H_
