...
#ifndef LYNXTRON_SHELL_UI_DISPLAY_DISPLAY_OBSERVER_H_
#define LYNXTRON_SHELL_UI_DISPLAY_DISPLAY_OBSERVER_H_
...
#endif  // LYNXTRON_SHELL_UI_DISPLAY_DISPLAY_OBSERVER_H_
