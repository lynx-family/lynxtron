...
#ifndef SHELL_UI_DISPLAY_WIN_UWP_TEXT_SCALE_FACTOR_H_
#define SHELL_UI_DISPLAY_WIN_UWP_TEXT_SCALE_FACTOR_H_
...
#endif  // SHELL_UI_DISPLAY_WIN_UWP_TEXT_SCALE_FACTOR_H_
