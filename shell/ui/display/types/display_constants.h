...
#ifndef LYNXTRON_SHELL_UI_DISPLAY_TYPES_DISPLAY_CONSTANTS_H_
#define LYNXTRON_SHELL_UI_DISPLAY_TYPES_DISPLAY_CONSTANTS_H_
...
#endif  // LYNXTRON_SHELL_UI_DISPLAY_TYPES_DISPLAY_CONSTANTS_H_
