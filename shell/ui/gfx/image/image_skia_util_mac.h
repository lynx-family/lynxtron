...
#ifndef LYNXTRON_SHELL_UI_GFX_IMAGE_IMAGE_SKIA_UTIL_MAC_H_
#define LYNXTRON_SHELL_UI_GFX_IMAGE_IMAGE_SKIA_UTIL_MAC_H_
...
#endif  // LYNXTRON_SHELL_UI_GFX_IMAGE_IMAGE_SKIA_UTIL_MAC_H_
