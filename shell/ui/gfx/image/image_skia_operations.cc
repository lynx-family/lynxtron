...
//   SuperimposedImageSource& operator=(const SuperimposedImageSource&) =
//   delete;
...
//     canvas->DrawRect(RectF(0, fades_down_ ? -1 : size().height(), 1, 1),
//     flags);
//   }
...
//   ImageWithRoundRectClipSource& operator=(const
//   ImageWithRoundRectClipSource&) =
//       delete;
...
//   return
//   gfx::CanvasImageSource::MakeImageSkia<ImageWithCircleBackgroundSource>(
//       radius, color, image);
// }
