...
#ifndef LYNXTRON_SHELL_UI_GFX_GEOMETRY_RECT_CONVERSIONS_H_
#define LYNXTRON_SHELL_UI_GFX_GEOMETRY_RECT_CONVERSIONS_H_
...
#endif  // LYNXTRON_SHELL_UI_GFX_GEOMETRY_RECT_CONVERSIONS_H_
