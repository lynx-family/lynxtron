...
#import "shell/ui/cocoa/electron_bundle_mover.h"
...
template <>
struct Converter<lynxtron::BundlerMoverConflictType> {
  static v8::Local<v8::Value> ToV8(v8::Isolate* isolate,
                                   lynxtron::BundlerMoverConflictType value) {
    switch (value) {
      case lynxtron::BundlerMoverConflictType::kExists:
        return gin::StringToV8(isolate, "exists");
      case lynxtron::BundlerMoverConflictType::kExistsAndRunning:
