...
#ifndef SHELL_UI_PLATFORM_WINDOW_WIN_SCOPED_FULLSCREEN_VISIBILITY_H_
#define SHELL_UI_PLATFORM_WINDOW_WIN_SCOPED_FULLSCREEN_VISIBILITY_H_
...
#endif  // SHELL_UI_PLATFORM_WINDOW_WIN_SCOPED_FULLSCREEN_VISIBILITY_H_
