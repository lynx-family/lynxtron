...
#ifndef LYNXTRON_SHELL_UI_PLATFORM_WINDOW_WIN_SCOPED_FULLSCREEN_VISIBILITY_H_
#define LYNXTRON_SHELL_UI_PLATFORM_WINDOW_WIN_SCOPED_FULLSCREEN_VISIBILITY_H_
...
#endif  // LYNXTRON_SHELL_UI_PLATFORM_WINDOW_WIN_SCOPED_FULLSCREEN_VISIBILITY_H_
