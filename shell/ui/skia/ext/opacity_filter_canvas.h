...
#ifndef LYNXTRON_SHELL_UI_SKIA_EXT_OPACITY_FILTER_CANVAS_H_
#define LYNXTRON_SHELL_UI_SKIA_EXT_OPACITY_FILTER_CANVAS_H_
...
#endif  // LYNXTRON_SHELL_UI_SKIA_EXT_OPACITY_FILTER_CANVAS_H_
