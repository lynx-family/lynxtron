...
#ifndef LYNXTRON_SHELL_UI_SKIA_EXT_SKIA_UTILS_MAC_H_
#define LYNXTRON_SHELL_UI_SKIA_EXT_SKIA_UTILS_MAC_H_
...
#endif  // LYNXTRON_SHELL_UI_SKIA_EXT_SKIA_UTILS_MAC_H_
