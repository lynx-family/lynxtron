...
#import "shell/ui/base/cocoa/command_dispatcher.h"

#include "base/auto_reset.h"
#include "base/check_op.h"
#include "base/notreached.h"
#include "base/trace_event/trace_event.h"
#include "shell/ui/base/cocoa/cocoa_base_utils.h"
#import "shell/ui/base/cocoa/user_interface_item_command_handler.h"
...
- (BOOL)performKeyEquivalent:(NSEvent*)event {
  ...
  result = [_delegate postPerformKeyEquivalent:event
                                        window:_owner
                                  isRedispatch:NO];
  if (result == ui::PerformKeyEquivalentResult::kHandled) {
    return YES;
