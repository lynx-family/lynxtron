...
#include "shell/ui/gfx/geometry/rect_conversions.h"
...
//   // TODO(Guo Xi):support on windows
//   // dict.Set("colorSpace",
//   val.GetColorSpaces().GetRasterColorSpace().ToString());
...
//       break;
//       // TODO(Guo Xi): check piecewise-hdr
//     case gfx::ColorSpace::TransferID::PIECEWISE_HDR:
//       transfer = "piecewise-hdr";
//       break;
...
//     }
//     // TODO(Guo Xi): Add support for EBU_3213_E.
