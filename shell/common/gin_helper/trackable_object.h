...
#ifndef LYNXTRON_SHELL_COMMON_GIN_HELPER_TRACKABLE_OBJECT_H_
#define LYNXTRON_SHELL_COMMON_GIN_HELPER_TRACKABLE_OBJECT_H_
...
class TrackableObject : public TrackableObjectBase, public EventEmitter<T> {
 ...
 protected:
  ...
  void InitWith(v8::Isolate* isolate, v8::Local<v8::Object> wrapper) override {
    if (!weak_map_) {
      weak_map_ = new lynxtron::KeyWeakMap<int32_t>;
    }
 ...
 private:
  static lynxtron::KeyWeakMap<int32_t>* weak_map_;  // leaked on purpose
};

template <typename T>
lynxtron::KeyWeakMap<int32_t>* TrackableObject<T>::weak_map_ = nullptr;

}  // namespace gin_helper

#endif  // LYNXTRON_SHELL_COMMON_GIN_HELPER_TRACKABLE_OBJECT_H_
