...
#ifndef LYNXTRON_SHELL_BROWSER_APPLICATION_OBSERVER_H_
#define LYNXTRON_SHELL_BROWSER_APPLICATION_OBSERVER_H_
...
#endif  // LYNXTRON_SHELL_BROWSER_APPLICATION_OBSERVER_H_
