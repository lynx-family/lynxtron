...
Application::UserTask::UserTask() = default;
Application::UserTask::UserTask(const UserTask&) = default;
Application::UserTask::~UserTask() = default;
...
//   //                          base::BindOnce(&OnIconDataAvailable,
//   //                          normalized_path,
//   //                                         app_display_name,
//   //                                         std::move(promise)),
...
//   // TODO(Guo Xi): GetFileIcon
//   // GetFileIcon(app_path, isolate, cancelable_task_tracker_,
//   app_display_name,
//   //             std::move(promise));
// }
...
void Application::SetAppUserModelID(const std::wstring& name) {
  lynxtron::SetAppUserModelID(name);
}

bool Application::SetUserTasks(const std::vector<UserTask>& tasks) {
...
//   // 1. |contents| is between 1 and 99 inclusive => Set the accessibility
//   text
...
//                                  IDS_BADGE_UNREAD_NOTIFICATIONS,
//                                  badge_count_)
//                            // Case 2.
//                            : l10n_util::GetPluralStringFUTF8(
...
// void Application::UpdateBadgeContents(
//     HWND hwnd,
...
PCWSTR Application::GetAppUserModelID() {
